...
<div id="content-bar">
	<div id="content">
		...
		<a class="iframe" href="https://docs.google.com/spreadsheet/pub?key=0AoaqnwjhP74adDZSQjItcjI5ai1GNWNsUVJUV2pXeVE&single=true&gid=0&widget=true"></a>
        ...
        <p> <strong>Voorstellen aanpassingen</strong>: Wil je liever iets anders zien op de site (iets dat nu niet fout is, maar wellicht wel beter kan), dan is dit de plek om het neer te gooien. Voorbeelden: <em>'het logo is lelijk, kunnen we niet een foto van mijn lelijke hoofd gebruiken?'</em> of <em>'Kunnen we niet een catering-pagina toe voegen, om te laten zien dat we ook homemade water verkopen?'</em></p>
        
        <p> <a href="https://docs.google.com/spreadsheet/ccc?key=0AoaqnwjhP74adDZSQjItcjI5ai1GNWNsUVJUV2pXeVE&usp=sharing" target="_blank">Pas hier het document aan! </a> </p>
	</div>
