    ...
    <div id="content">
       ...
       <div class="newsitem">
            <div class="date"><label> 3 </label><span> JUN</span></div>
                ...
                <p class="first"> Misschien hebben jullie het al voorbij zien komen op Facebook of op tv en site van het programma, maar onze lead-singer Laurens heeft het weten te schoppen tot de tv-show van de Beste Singer-Songwriter van Nederland! Om daar te komen heeft hij zich een weg moeten banen door de meer dan 600 inschrijvingen heen om zo te belanden bij de laatste 32 kandidaten waarmee het programma begint. Hoe hij het daar gaat schoppen kunnen jullie <strong>maandagavond 3 juni zien op Nederland 3 om 20.25!</strong> Kijken dus! </p>
       </div>
        
        <div class="newsitem">
            <div class="date"><label> 3 </label><span> JUN</span></div>
        	    <h3>  HomemadeWater.nl officieel online!</h3>
            	<img src="images/screenshot.jpg" alt="Homemade Water is de lucht in! We zijn online!" title="Homemade Water is nu officieel online. Dit screenshot bevestigt dat nog eens." />
                <p class="first"> Jaaaaa mensen, het is zover! HomemadeWater.nl is nu officieel online! Het feit dat dit te lezen is, geeft voldoende bewijs. Met deze site houden we jullie op de hoogte van onze gigs, nieuwtjes en ontwikkelingen!</p>
        ...
        <div class="newsitem">
       	...
       	<div class="newsitem">
            <div class="date"><label> 25 </label><span> APR</span></div>
                ...
                <p class="first"> 25 April traden we op bij een feest genaamd Overstag in het Floratheater in onze mooie thuisstad: Delft. Het Floratheater bleek een mooi oud pornotheater compleet met houten bioscoop stoeltjes te zijn. </p>
                <p>Gelukkig was het vroegere publiek thuis gebleven en stond de zaal nu vol met windsurf dudes en chicks van de Delfste studentenvereniging Plankenkoorts. Het publiek was al snel in beweging gebracht en bij het nog redelijk relaxte nummer 'New Shoes' van Paolo Nutini ontstond er al een mosh-pit. </p>
                
                <p>De sfeer zat er goed in en de temperatuur nam snel toe! Na afloop van het optreden werd er hard geroepen om NOG EEN NUMMER! En tsja.. wij zijn de slechtsten niet, dus hebben we ze nog een toegift cadeau gedaan. Dj's zoals "DJ Pilskabouter" namen het publiek van ons over en wij mengden ons in het publiek om van het geslaagde feestje te genieten. </p>
       </div>
