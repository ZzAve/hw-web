    ...
    <div id="content">
       ...
       <div class="newsitem">
            <div class="date"><label> 3 </label><span> JUN</span></div>
                ...
                <p> Misschien hebben jullie het al voorbij zien komen op Facebook of op tv en site van het programma, maar onze lead-singer Laurens heeft het weten te schoppen tot de tv-show van de Beste Singer-Songwriter van Nederland! </p>
