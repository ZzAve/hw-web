			...
			if ($album_presence !== FALSE) {
                ...
                <div id="photolist-overflow">   
                 ...
                 <div id="showPhoto"> <!-- div that can be used to "pop up" -->
                    ...
                    <img src="<?=$album_folder.$album_presence."/".$foto?>" alt="De gevraagde foto is helaas niet beschikbaar, door een fout op de server. Deze fout wordt z.s.m. verholpen. Ons excuses voor het ongemak" title="Awesome foto"/>   
