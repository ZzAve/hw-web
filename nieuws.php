    ...
    <div id="content">
        ...
        <h2> Om ons op de voet te volgen, verwijzen we u door naar onze <a href="http://www.facebook.com/HomemadeWater">facebook pagina</a></h2>   
       	...
       	<div class="newsitem" id="news_Kurk">
            ...
            <p> De veelzijdigheid van Homemade Water is weer uitgebreid! Na een drietal experimentele optredens in een akoestische setting hebben we besloten om nu officieel Homemade Water light leven in te blazen!</p>
        ...
        <div class="newsitem" id="news_Kurk">
			...
			<p>De foto's van het optreden staan inmiddels ook online! Check snel de <a href="./foto.php">fotopagina</a>!</p>
    	</div>
       			
        <div class="newsitem">
            <div class="date"><label> 11 </label><span> JUN</span></div>
            <h3>  Opkomende tentamens, uhh optredens.</h3>
       ...
       <div class="newsitem">
            ...
            <h3>  Laurens' deelname aan de Beste Singer-Songwriter van Nederland</h3>
            <img src="images/laurens_nieuws_thumb.jpg" alt="Laurens doet mee aan de beste singersongwriter." title="Laurens doet mee aan de beste singersongwriter. Dit was zijn beste shot!" />
            <p> Misschien hebben jullie het al voorbij zien komen op Facebook, tv, of de site van het programma, maar onze lead-singer Laurens heeft het weten te schoppen tot de tv-show van de <strong>Beste Singer-Songwriter van Nederland!</strong> </p>
            
            <p>Om daar te komen heeft hij zich een weg moeten banen door de meer dan 600 inschrijvingen heen om zo te belanden bij de laatste 32 kandidaten waarmee het programma begint. Hoe hij het daar gaat schoppen kunnen jullie <strong>maandagavond 3 juni zien op Nederland 3 om 20.25!</strong> Kijken dus! </p>
      </div>
        
        <div class="newsitem">
            <div class="date"><label> 3 </label><span> JUN</span></div>
            <h3>  HomemadeWater.nl officieel online!</h3>
            <img src="images/screenshot_nieuws.jpg" alt="Homemade Water is de lucht in! We zijn online!" title="Homemade Water is nu officieel online. Dit screenshot bevestigt dat nog eens." />
            <p> Jaaaaa mensen, het is zover! HomemadeWater.nl is nu officieel online! Het feit dat dit te lezen is, geeft voldoende bewijs. Met deze site houden we jullie op de hoogte van onze gigs, nieuwtjes en ontwikkelingen!</p>
            <p> Bovendien zijn er foto's, video's en audio opnamen te vinden van onze optredens en nummers. Ook kunt u via deze site gemakkelijk contact met ons opnemen voor boekingen of vragen. </p>
       </div>
        
        <div class="newsitem">
            <div class="date"><label> 4 </label><span> MEI</span></div>
            <h3>  Voorronde van The Clash of the Coverbands </h3>

            <img src="images/albums/1e ronde Clash of the Coverbands.jpg" alt="Foto voorronde Clash" title="Homemade Water is door de voorrondes van Clash of the Coverbands!" />
            ...
            <p>Voor dit optreden werden we beloond met de jury prijs en bekroond tot "beste band van de avond"! <a href="http://www.theclashofthecoverbands.com/show/verslagen/item,671,Voorronde-Regio-West-2013.html"> Het uitgebreide jury verslag valt hier te lezen.</a></p>
       	...
       	<div class="newsitem">
            <div class="date"><label> 25 </label><span> APR</span></div>
            <h3>  Optreden  bij windsurf vereniging Plankenkoorts</h3>
            <img src="images/nieuws_plankenkoorts.jpg" alt="Plankenkoorts_foto" title="Het optreden bij Plankenkoorts" />
            <p> Op 25 April traden we op bij een feest genaamd Overstag in het Floratheater in onze mooie thuisstad: Delft. Het Floratheater bleek een mooi oud pornotheater compleet met houten bioscoop stoeltjes te zijn. Gelukkig was het vroegere publiek thuis gebleven en stond de zaal nu vol met windsurf dudes en chicks van de Delfste studentenvereniging Plankenkoorts. </p> 
            <p> Het publiek was al snel in beweging gebracht en bij het nog redelijk relaxte nummer 'New Shoes' van Paolo Nutini ontstond er al een mosh-pit. De sfeer zat er goed in en de temperatuur nam snel toe! Na afloop van het optreden werd er hard geroepen om NOG EEN NUMMER! En tsja.. wij zijn de slechtsten niet, dus hebben we ze nog een toegift cadeau gedaan. Dj's zoals "DJ Pilskabouter" namen het publiek van ons over en wij mengden ons in het publiek om van het geslaagde feestje te genieten. </p>
       </div>
